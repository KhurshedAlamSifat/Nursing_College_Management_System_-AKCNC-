<%@ Page Title="Circular Details" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" CodeFile="CircularDetails.aspx.cs" Inherits="Pages_User_CircularDetails" %>
        ...
        <asp:Panel ID="pnPrint" runat="server">
            <table class="table table-bordered table-responsive">
                <tbody>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:HyperLink ID="ApplyLink" runat="server" Text="Apply"></asp:HyperLink>
                        </td>
                    </tr>
                </tbody>
            </table>
