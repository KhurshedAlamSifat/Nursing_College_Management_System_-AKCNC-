<%@ Page Title="Manage Student Fee Mapping For Coaching" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ManageStudentFeeMappingForCoaching.aspx.cs" Inherits="Pages_FeePaymentModule_ManageStudentFeeMappingForCoaching" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Current C.Unit">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lbl_StudentFeeMapping_WaiverPercentage_old" runat="server" Text='<%#Eval("StudentFeeMapping_ConsumptionUnit") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="New Amount" ControlStyle-Width="50px">
                        <ItemTemplate>
                            ...
                            <asp:TextBox ID="tbx_StudentFeeMapping_AppliedAmount_New" Style="border: 0px" runat="server" Text=''></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="Server">
    <script type="text/javascript">
        function tbx_NewConsumptionUnitOnInput(tbx_NewConsumptionUnit_id) {
            ...
            document.getElementById(tbx_NewConsumptionUnit_id.replace('cphMain_gvList_tbx_NewConsumptionUnit', 'cphMain_gvList_tbx_StudentFeeMapping_AppliedAmount_New')).value = AppliedAmount_New;
        }
    </script>
</asp:Content>
